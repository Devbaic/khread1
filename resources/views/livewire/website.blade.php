    ...
    <div class="row align-items-center justify-content-center">
      <div class="mb-5 col-lg-6 mb-lg-0">
        <div class="block text-center text-lg-start pe-0 pe-xl-5">
          <h1 class="mb-4 text-capitalize">Lifelong learning!</h1>
          <p class="mb-4">The more you read, the more you learn.</p> <a type="button"
            class="btn btn-primary" href="{{route('books')}}" >See More<span style="font-size: 14px;" class="ms-2 fas fa-arrow-right"></span></a>
        </div>
      </div>
      <div class="col-lg-6">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-4 col-md-6">
        <div class="pt-4 section-title">
          <p class="mb-3 text-primary text-uppercase fw-bold">Description Books</p>
          <h1>Our online Books</h1>
          <p>Type Of BooKs</p>
        </div>
      </div>
      @if($books->isNotEmpty())
      ...
      @endphp
        ...
        <a class="text-black" href="service-details.html">
          <div class="block"> <span class="mb-4 text-center colored-box h3">{{$x++}}</span>
            <h3 class="mb-3 service-title">{{$book->name}}</h3>
            <p class="mb-0 service-description">អ្នកនិពន្ធ:​ {{$book->author}}</p>
            <p class="mb-0 service-description">{{$book->description}}</p>
             <a
            class="btn btn-primary" href="{{route('books')}}" >Read More<span style="font-size: 14px;" class="ms-2 fas fa-arrow-right"></span></a>
          </div>
        </a>
      </div>
     @endforeach
    @endif
      <div style="text-align:center; margin-top:30px;">
        <a href="{{ route('books') }}" class="cute-btn">
            🌸 See more
            <div class="dot"></div>
            <div class="dot"></div>
            <div class="dot"></div>
